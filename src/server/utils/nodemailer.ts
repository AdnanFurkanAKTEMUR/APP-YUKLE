...
type mailType = z.infer<typeof mailTypeSchema>;
...
async function mailOptionsFunc(params: mailType) {
  return { from: process.env.GMAIL_ACCOUNT_DEV, to: params.to, subject: params.subject, text: params.text };
}
